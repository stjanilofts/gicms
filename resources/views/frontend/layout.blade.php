...
<html class="no-js" lang="">
    <head>
        ...
        <link rel="stylesheet" href="/css/bundle.css?v=3">
        ...
        <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.4/jquery.min.js?v=3"></script>
        <script src="/js/bundle.js?v=3"></script>
        <script>
